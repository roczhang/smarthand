...
namespace app
{
    public partial class Main : Form
    {
        ...
        private void LostAllcostControl(bool leave)
        {
            ...
            CostFormular cf = new CostFormular(allcost, m_setting.Ratio, m_setting.Remainder);
        ...
        private void CompenationMenuItem_Click(object sender, EventArgs e)
        {
            Form formular = new compensationForm(m_setting);
            formular.Show();
        }
